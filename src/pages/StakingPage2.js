...
const HomePage = () => {
  ...
  const init = async () => {
    ...
    const leadToken = new web3.eth.Contract(
      ERC20.abi,
      "0x44A66a3d1F93d517bd887debf0781b5046aB8303" //rinkeby
  ...
  async function registerAndStake() {
    ...
    try {
      ...
      await leadToken.methods
        .approve("0x9f6bf4372510BBA6C72EECA3D5C5C10b35351393", arg)
                ...
                <Card title="Rules">
                  <div className="flex flex-col pt-8 pb-4 text-white text-center">
                     <ul>
                        ...
                        <li>
                          2. Stake KORT tokens for 8 days and get dividend after 30 days
                        </li>
                        <li>
                          3. Claim earned rewards after 30 days
                        </li>
                        <li>
                          4. Unstake KORT tokens within 8 days or it gets locked
                        </li>
                      </ul>
                  </div>
                </Card>
              ...
              <Card title="Total Staked KORT">
                <div className="flex flex-col pt-8 pb-4 text-white">
                  <div className="text-center">
                    ...
                    <span className="text-white text-2xl ml-2">KORT</span>
                  </div>
                  <div className="text-center">
                    {(
                    ...
                    <div className="text-gray-400 text-lg font-thin">
                      <ul>
                        ...
                        <li>
                          Minimum Stake:{"  "}
                          <span className="text-white text-2xl">
                            {parseInt(minStake) / 1000000000000000000} KORT
                          </span>
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="text-center text-white text-2xl mt-8 mx-2">
                    <div>
                      <div>
                        ...
                        {parseFloat(stakingRewards) / 1000000000000000000} KORT
                      </div>
                      <div>
                        <span className="text-gray-400 text-lg">
                          Daily Return:{" "}
                    ...
                    <div>
                      <div>
                        ...
                        {parseFloat(referralRewards) / 1000000000000000000} KORT
                      </div>
                      <div>
                        <span className="text-gray-400 text-lg">
                          Referral Count:
